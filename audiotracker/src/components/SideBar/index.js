...
export function SideBar({ getAllFile }) {
  ...
  return (
    <>
      ...
      <aside className="max-md:hidden w-[20%] bg-[#152259] h-screen flex flex-col items-center justify-between pb-16 ">
        {/* Logo Section */}
...
export function LinkAside({ icon, children, className, to }) {
  return (
    <div
